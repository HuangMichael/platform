...
import com.subway.template.HtTemplate;
import com.subway.template.HtTemplateService;
...
public class AutoGenerationService {
    ...
    private List<HtTemplate> htTemplateList;
     ...
     * @throws SQLException
     */
    public void genCode(App app, String templateDir, String autoGeneratedFile, List<TableColumnConfig> tableColumnConfigList) throws IOException, TemplateException, ClassNotFoundException,
            SQLException {
