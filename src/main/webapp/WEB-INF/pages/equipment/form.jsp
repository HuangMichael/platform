...
<form class="form-horizontal" id="form" method="post">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" id="description" name="description" v-model="equipment.description"
                           required/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="expectedYear" name="expectedYear" v-model="equipment.expectedYear"
                           required/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="manageLevel" name="manageLevel" v-model="equipment.manageLevel"
                           required/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="originalValue" name="originalValue"
                           v-model="equipment.originalValue" required/>
                </div>
                <label for="productDate" class="col-md-2 control-label">生产日期</label>
                <div class="col-md-4">
                    <input class="form-control" id="productDate" name="productDate" v-model="equipment.productDate"
                           required/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="productFactory" name="productFactory"
                           v-model="equipment.productFactory" required/>
                </div>
                <label for="purchaseDate" class="col-md-2 control-label">购置日期</label>
                <div class="col-md-4">
                    <input class="form-control" id="purchaseDate" name="purchaseDate" v-model="equipment.purchaseDate"
                           required/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="purchasePrice" name="purchasePrice"
                           v-model="equipment.purchasePrice" required/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="warrantyPeriod" name="warrantyPeriod"
                           v-model="equipment.warrantyPeriod" required/>
                </div>
            </div>
            <div class="form-group">
                <label for="eqClass_id" class="col-md-2 control-label">设备分类</label>
                <div class="col-md-4">
                    <input class="form-control" id="eqClass_id" name="eqClass.id" v-model="equipment.eqClass.id"
                           required/>
                </div>
                <label for="locationId" class="col-md-2 control-label">设备位置</label>
                <div class="col-md-4">
                    <input class="form-control" id="locationId" name="location.id" v-model="equipment.location.id"
                           required/>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer">
        ...
        <button id="saveBtn" name="saveBtn"  onclick="printQrCode"
