    ...
    <div class="form-group">
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="form-group">
                ...
                <label class="col-md-2 control-label" for="resourceName">资源名称</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <label class="col-md-2 control-label" for="appName">应用名称</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label" for="status">启用状态</label>
                <div class="col-md-4">
