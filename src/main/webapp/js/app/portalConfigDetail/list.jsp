            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box border blue">
                        <div class="box-title">
                            <h4><i class="fa fa-table"></i>门户配置详细信息</h4>
                        </div>
                        ...
                        <div class="box-body">
                            <div id="contentDiv">
                                <div class="box-body">
                                    ...
                                    <table id="portalConfigDetailListTable"
...
<script type="text/javascript" src="/js/app/portalConfigDetail/portalConfigDetail.js"></script>
