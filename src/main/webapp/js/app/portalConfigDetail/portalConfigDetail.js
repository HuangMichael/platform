...
//导出必须配置的两个量
dataTableName = "#portalConfigDetailListTable";
docName = "门户配置详细信息";
mainObject = "portalConfigDetail";
formName = "#form";
...
vdm.$set("portalConfigDetail", object);
...
*/
function add() {
vdm.$set("portalConfigDetail", null);
$("#editModal").modal("show");
}
